...
Vehicle::Vehicle(GLfloat x, GLfloat y, GLfloat z, GLfloat xFront, GLfloat yFront, GLfloat zFront, GLfloat w, GLfloat h, GLfloat l, float hOffset) : GraphicalElement(x, y, z), front(Vector3D(xFront, yFront, zFront)), width(w), height(h), length(l)
{
    r = g = b = 1.0f;
