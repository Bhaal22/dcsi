...
void PalmTree::shape()
{
    ...
    // Assign the texture coordinates and vertices for the FRONT Side
    	...
    	glTexCoord2f(0.0f, 0.0f); glVertex3f(x + width / 2,            y,            z + 3*length / 2);
    	glTexCoord2f(0.0f, 1.0f); glVertex3f(x + width / 2,            y + height,    z + 3*length / 2);
    	glTexCoord2f(1.0f, 1.0f); glVertex3f(x + width / 2,            y + height,    z + length / 2);
