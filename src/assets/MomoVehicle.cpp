...
void MomoVehicle::shape()
{
	...
	glEnable(GL_TEXTURE_2D);  
  	...
  	glBegin(GL_QUADS);
  		...
  		glTexCoord2f(1.0f, 0.0f); glVertex3f(width/2, 0,  -length/4);
  		glTexCoord2f(1.0f, 1.0f); glVertex3f(-width/2, 0, -length/4);
  		glTexCoord2f(0.0f, 1.0f); glVertex3f(-width/2,  0, length/4);
  		glTexCoord2f(0.0f, 0.0f); glVertex3f(width/2, 0,  length/4);

  		glTexCoord2f(1.0f, 0.0f); glVertex3f(width/2, 0, -length/4);
  		glTexCoord2f(1.0f, 1.0f); glVertex3f(-width/2, 0, -length/4);
  		glTexCoord2f(0.0f, 1.0f); glVertex3f(-width/2, height, -length/4);
  		glTexCoord2f(0.0f, 0.0f); glVertex3f(width/2, height, -length/4);

  		glTexCoord2f(1.0f, 0.0f); glVertex3f(width/2, height, length/4);
  		glTexCoord2f(1.0f, 1.0f); glVertex3f(-width/2, height, length/4);
  		glTexCoord2f(0.0f, 1.0f); glVertex3f(-width/2, 0, length/4);
  		glTexCoord2f(0.0f, 0.0f); glVertex3f(+width/2, 0, length/4);
  ...
  glBegin(GL_QUADS);
  		...
  		glTexCoord2f(1.0f, 0.0f); glVertex3f(width/2, height, -length/2);
  		glTexCoord2f(1.0f, 1.0f); glVertex3f(-width/2, height, -length/2);
  		glTexCoord2f(0.0f, 1.0f); glVertex3f(-width/2, height, length/2);
  		glTexCoord2f(0.0f, 0.0f); glVertex3f(width/2, height, length/2);
  glEnd();
